...
public class Button extends Actor
{
    ...
    public Button(String text, int size, String first, String second)
    {
        ...
        text1 = new GreenfootImage(text, fontSize, Color.BLACK, (new Color(0,0,0,0)));
        ...
        text1.drawImage(getImage(), (getImage().getWidth() - text1.getWidth())/2 ,(getImage().getHeight() - text1.getHeight())/2);
